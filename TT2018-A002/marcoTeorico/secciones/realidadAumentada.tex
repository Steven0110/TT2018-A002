...
\begin{itemize}
	\item \textbf{Escaneo de objetos para su reconocimiento}.- Wikitude proporciona un escaneo por medio de una cámara de un dispositívo móvil hacia los objetos reales. Las últimas versiones de Wikitude proporciona una extensión llamada \textbf{Simultaneous Location  and Mapping SLAM}  que permite escaneos mas amplios como espacios de interiores. 
