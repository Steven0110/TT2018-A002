...
\begin{itemize}
	\item \textbf{Rastreo de movimiento}.- Permite al teléfono celular entender y rastrear su posición realtiva al mundo real.
	
	\item \textbf{Entendimiento ambiental}.- Permite al dispositivo móvil detectar el tamaño y localización de todo tipo de superficies: horizontales, verticales y angulares como el suelo, una mesa de café o muros.
	
	\item \textbf{Estimación de luz}.- Permite realizar una estimación de la cantidad de luz en el ambiente.
\end{itemize}

\noindent
Dado que ARCore es una tecnología nueva (su primer publicación oficial fue en Febrero de 2018)
