...
Cuando nos movemos de posición, la cámara se apoya de un sistema de coordenadas  en tercera dimensión en relacion a la posicion absoluta del marcador. La cámara está posicionada en el origen del sistema de coordenadas, mirando a lo largo del eje Z. Dos ejes del sistema de coordenadas del marcador son paralelos a los lados del marcador cuadrado. ARToolKit demas utiliza algunas extensiones para su correcto funcionamiento que a continuación se mencionan.
\begin{itemize}
