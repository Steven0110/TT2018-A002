...
\usepackage{colortbl}
\usepackage{array,booktabs,arydshln,xcolor,multirow}  %
\usepackage{caption}
...
%	   \input{./marcoTeorico/secciones/SDK}
 %  	   \input{./marcoTeorico/secciones/ARCore}
%   	   \input{./marcoTeorico/secciones/ARToolKit}
%   	   \input{./marcoTeorico/secciones/API}
%   	   \input{./marcoTeorico/secciones/SGBD}
 %  	   \input{./marcoTeorico/secciones/OpenGL}
  % 	   \input{./marcoTeorico/secciones/Unity}
   %	   \input{./marcoTeorico/secciones/Blender}
   	%   \input{./marcoTeorico/secciones/Render}
	\input{./bibliografia/bibliografia}
		%\input{./bibliografia/secciones/fuentes}
\end{document}
